...
public class MathClassMethods{
	public static void main(String[] args){
		...
		System.out.printf("The absolute rounded is %d%n",Math.round(num1));
	
		System.out.printf("The absolute power is %f%n",Math.pow(num1,2));
		...
		System.out.printf("The minimum number is %d%n",Math.max(number3, number4));
